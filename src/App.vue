<template>
  <div id="app">
    <div class="nav_header">
      ...
      <div class="headr_d2">
        <ul>
          <li class="domFullScreen" @click="toggleFull"><svg-icon icon-class="quanping"></svg-icon></li>
          <li class="domPersonal">
            <el-dropdown @command="handleCommand" placement="bottom-end">
              ...
              <el-dropdown-menu slot="dropdown">
                ...
                <el-dropdown-item command="login/logOut" divided>退出登陆</el-dropdown-item>
              </el-dropdown-menu>
            </el-dropdown>
          </li>
        </ul>
