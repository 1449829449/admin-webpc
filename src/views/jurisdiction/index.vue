<template>
  <div class="jurisdiction">
    <el-button class="addtop" type="primary" icon="el-icon-plus"  @click="addFirst">新增</el-button>
    <el-table :data="tableData" row-key="id" border size="mini" :tree-props="{ children: 'children' }">
      <el-table-column prop="name" align="left" label="名称"> </el-table-column>
      <el-table-column label="操作" align="center" width="300px">
        <template slot-scope="scope">
          <el-button type="text" size="small" icon="el-icon-plus" @click="addTwo(scope.row)">添加</el-button>
    ...
    <el-drawer
      ...
      <div class="drewWrap">
        <!-- 弹框内容 -->
        <el-form class="drawer_form" ref="drawerform" :rules="drawerrules" :model="form" label-width="120px">
          <el-form-item v-if="stateVal !== '添加'" label="是否有子菜单" prop="PId">
